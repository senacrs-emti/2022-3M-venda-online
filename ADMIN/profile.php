      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello add banco</h1>
            <p class="text-white mt-0 mb-5">Aqui é sua página de perfil, pode ver suas tarefas e os trabalhos completos.</p>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                 Add banco de dados<span class="font-weight-light">, 27</span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>Cidade, Cidade
                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>O que voce faz na empresa - ADMIN
                </div>
                <div>
                  <i class="ni education_hat mr-2"></i>Qual sua formação
                </div>
                <hr class="my-4" />
                <p>Uma descrição sobre você</p>
