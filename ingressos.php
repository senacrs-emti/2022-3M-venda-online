...
<div class="card">
  ...
  <span class="text-title">R$900,1</span>
  <div class="card-button">
  <a class="botao" href="cadeiras.php">  
...
<a href="compra.php"><img src="imagens/gremioxsampaio.png" class="card-img2"></a>
  ...
  <span class="text-title2">R$900,1</span>
...
<a href="compra.php"><img src="imagens/gremioelondrina.png" class="card-img3"></a>
  ...
  <span class="text-title3">R$900,1</span>
...
<div class="card">
  ...
  <div class="card-info">
    <p class="text-title">GRÊMIO X NÁUTICO </p>
    <p class="text-body">Jogaço para assistir ao vivo</p>
  </div>
  <div class="card-footer">
  <span class="text-title">R$900,1</span>
